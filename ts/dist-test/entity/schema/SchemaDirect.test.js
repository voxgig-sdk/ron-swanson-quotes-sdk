...
(0, node_test_1.describe)('SchemaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RonSwansonQuotesSDK({
...
function liveScenariosActive() { return false && process.env.RON_SWANSON_QUOTES_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RonSwansonQuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RON_SWANSON_QUOTES_TEST_SCHEMA_ENTID'];
    ...
    const client = new __1.RonSwansonQuotesSDK({
        base: 'http://localhost:8080',
