...
function envOverride(m) {
    if ('TRUE' === process.env.RON_SWANSON_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.RON_SWANSON_QUOTES_TEST_OVERRIDE) {
    ...
    m.RON_SWANSON_QUOTES_TEST_EXPLAIN = process.env.RON_SWANSON_QUOTES_TEST_EXPLAIN || m.RON_SWANSON_QUOTES_TEST_EXPLAIN;
    return m;
}
