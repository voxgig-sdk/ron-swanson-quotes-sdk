...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RONSWANSONQUOTES_TEST_LIVE ||
    'TRUE' === process.env.RONSWANSONQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.RONSWANSONQUOTES_TEST_EXPLAIN = process.env.RONSWANSONQUOTES_TEST_EXPLAIN || m.RONSWANSONQUOTES_TEST_EXPLAIN
