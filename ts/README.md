...
The TypeScript SDK for the RonSwansonQuotes API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new RonSwansonQuotesSDK({ apikey: '...' })
