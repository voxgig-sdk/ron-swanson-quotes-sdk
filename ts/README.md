# RonSwansonQuotes TypeScript SDK



The TypeScript SDK for the RonSwansonQuotes API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/ron-swanson-quotes-sdk/releases](https://github.com/voxgig-sdk/ron-swanson-quotes-sdk/releases)
...
```ts
new RonSwansonQuotesSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `RonSwansonQuotesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `RonSwansonQuotesSDK.test(testopts?, sdkopts?)` | `RonSwansonQuotesSDK` | Create a test-mode client. |
...
| `client` | `client(): RonSwansonQuotesSDK` | Return the parent SDK client. |
...
ron-swanson-quotes/
├── src/
│   ├── RonSwansonQuotesSDK.ts        # Main SDK class
