# RonSwansonQuotes TypeScript SDK Reference

Complete API reference for the RonSwansonQuotes TypeScript SDK.
...
```ts
new RonSwansonQuotesSDK(options?: object)
```
...
#### `RonSwansonQuotesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `RonSwansonQuotesSDK` instance in test mode.
...
Alias for `RonSwansonQuotesSDK.test()`.
...
Return the parent `RonSwansonQuotesSDK` instance.
