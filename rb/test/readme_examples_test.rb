...
#      offline in seeded test mode (RonSwansonQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RonSwansonQuotes_sdk.rb")
  SDK_CLASS = "RonSwansonQuotesSDK"
