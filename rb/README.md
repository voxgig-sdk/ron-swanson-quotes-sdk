...
The Ruby SDK for the RonSwansonQuotes API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.RonSwansonQuotes(nil).load(
  { "id" => "test01" }, nil
)
