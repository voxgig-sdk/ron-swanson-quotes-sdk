...
The Python SDK for the RonSwansonQuotes API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.RonSwansonQuotes(None).load(
    {"id": "test01"}, None
)
