# RonSwansonQuotes Python SDK



The Python SDK for the RonSwansonQuotes API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ron-swanson-quotes-sdk/releases)) or
...
```
py/
├── ronswansonquotes_sdk.py         -- Main SDK module
