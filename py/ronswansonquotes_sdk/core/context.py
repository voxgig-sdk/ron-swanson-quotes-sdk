...
from ronswansonquotes_sdk.core.helpers import get_ctx_prop, to_map
...
class RonSwansonQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RonSwansonQuotesControl()
        ...
        if isinstance(sp, RonSwansonQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RonSwansonQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RonSwansonQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RonSwansonQuotesOperation({})
    ...
    def make_error(self, code, msg):
        return RonSwansonQuotesError(code, msg, self)
