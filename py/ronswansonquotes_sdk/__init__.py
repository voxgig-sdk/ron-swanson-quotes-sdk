...
from ronswansonquotes_sdk.utility import register

# Load features
from ronswansonquotes_sdk.feature.base_feature import RonSwansonQuotesBaseFeature
from ronswansonquotes_sdk.features import _has_feature, _make_feature
...
class RonSwansonQuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RonSwansonQuotesUtility()
    ...
    def get_utility(self):
        return RonSwansonQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RonSwansonQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Quote(self, data=None) -> "QuoteEntity":
        ...
        from ronswansonquotes_sdk.entity.quote_entity import QuoteEntity
    ...
    def Schema(self, data=None) -> "SchemaEntity":
        ...
        from ronswansonquotes_sdk.entity.schema_entity import SchemaEntity
        return SchemaEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RonSwansonQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
