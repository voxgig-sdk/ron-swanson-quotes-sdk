...
def make_error_util(ctx, err):
    if ctx is None:
        from ronswansonquotes_sdk.core.context import RonSwansonQuotesContext
        ctx = RonSwansonQuotesContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, RonSwansonQuotesError):
        errmsg = err.msg
    ...
    sdk_err = RonSwansonQuotesError("", msg, ctx)
