# RonSwansonQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RonSwansonQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RonSwansonQuotesSDK(...) and RonSwansonQuotesSDK.test(...) become
#      RonSwansonQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ronswansonquotes_sdk"
_SDK_CLASS = "RonSwansonQuotesSDK"
