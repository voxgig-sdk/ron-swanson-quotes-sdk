...
// RonSwansonQuotes SDK debug feature
...
class RonSwansonQuotesDebugFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _finish(RonSwansonQuotesContext $ctx, bool $ok): void
    {
