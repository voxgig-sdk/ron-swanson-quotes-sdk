...
// RonSwansonQuotes SDK timeout feature
...
class RonSwansonQuotesTimeoutFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _with_timeout(RonSwansonQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RonSwansonQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
