...
// RonSwansonQuotes SDK proxy feature
...
class RonSwansonQuotesProxyFeature extends RonSwansonQuotesBaseFeature
{
    ...
    public function init(RonSwansonQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RonSwansonQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
