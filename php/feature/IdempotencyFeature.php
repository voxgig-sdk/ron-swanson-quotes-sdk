...
// RonSwansonQuotes SDK idempotency feature
...
class RonSwansonQuotesIdempotencyFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _mutating(RonSwansonQuotesContext $ctx): bool
    {
