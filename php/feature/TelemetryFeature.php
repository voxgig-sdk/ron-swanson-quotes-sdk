...
// RonSwansonQuotes SDK telemetry feature
...
class RonSwansonQuotesTelemetryFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _close(RonSwansonQuotesContext $ctx, bool $ok): void
    {
