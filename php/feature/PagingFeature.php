...
// RonSwansonQuotes SDK paging feature
...
class RonSwansonQuotesPagingFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _is_list(RonSwansonQuotesContext $ctx): bool
    {
