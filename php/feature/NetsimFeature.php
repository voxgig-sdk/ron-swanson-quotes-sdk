...
// RonSwansonQuotes SDK netsim feature
...
class RonSwansonQuotesNetsimFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _simulate(RonSwansonQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RonSwansonQuotesContext $ctx, array $applied): void
    {
        $client = $this->client;
