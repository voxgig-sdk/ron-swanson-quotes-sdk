...
// RonSwansonQuotes SDK metrics feature
...
class RonSwansonQuotesMetricsFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _record(RonSwansonQuotesContext $ctx, bool $ok): void
    {
