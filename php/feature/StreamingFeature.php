...
// RonSwansonQuotes SDK streaming feature
...
class RonSwansonQuotesStreamingFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _iterate(RonSwansonQuotesResult $result): \Generator
    {
    ...
    private function _streamable(RonSwansonQuotesContext $ctx): bool
    {
