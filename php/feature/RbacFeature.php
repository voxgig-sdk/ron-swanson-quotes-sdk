...
// RonSwansonQuotes SDK rbac feature
...
class RonSwansonQuotesRbacFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _required(RonSwansonQuotesContext $ctx): ?string
    {
    ...
    private function _reject(RonSwansonQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(RonSwansonQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
