...
// RonSwansonQuotes SDK audit feature
...
class RonSwansonQuotesAuditFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _emit(RonSwansonQuotesContext $ctx, string $outcome): void
    {
