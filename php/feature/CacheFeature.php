...
// RonSwansonQuotes SDK cache feature
...
class RonSwansonQuotesCacheFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _through(RonSwansonQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
