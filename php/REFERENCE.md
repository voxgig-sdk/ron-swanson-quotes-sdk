# RonSwansonQuotes PHP SDK Reference

Complete API reference for the RonSwansonQuotes PHP SDK.
...
```php
require_once __DIR__ . '/ron-swanson-quotes_sdk.php';
...
#### `RonSwansonQuotesSDK::test($testopts = null, $sdkopts = null)`
...
```php
[$result, $err] = $client->Schema()->load(["id" => "schema_id"]);
```
