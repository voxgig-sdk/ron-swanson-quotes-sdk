...
// RonSwansonQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RonSwansonQuotesSDK::test)
...
{
    private const SDK_CLASS = 'RonSwansonQuotesSDK';
    ...
    private const SDK_BASE = 'ronswansonquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ronswansonquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
