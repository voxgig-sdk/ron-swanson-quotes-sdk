...
// RonSwansonQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RonSwansonQuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RonSwansonQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(RonSwansonQuotesOmni::structfix($val, Struct::undef()))) {
