...
class RonSwansonQuotesTestRunner
{
    ...
    {
        $live = self::getenv('RON_SWANSON_QUOTES_TEST_LIVE');
        $override = self::getenv('RON_SWANSON_QUOTES_TEST_OVERRIDE');
        ...
        $explain = self::getenv('RON_SWANSON_QUOTES_TEST_EXPLAIN');
...
class_alias('RonSwansonQuotesTestRunner', 'Runner');
class_alias('RonSwansonQuotesHelpers', 'Helpers');
