# RonSwansonQuotes PHP SDK



The PHP SDK for the RonSwansonQuotes API — an entity-oriented client using PHP conventions.
...
```php
require_once 'ronswansonquotes_sdk.php';
$client = new RonSwansonQuotesSDK($options);
```
...
```
php/
├── ronswansonquotes_sdk.php          -- Main SDK class
...
The main class (`ronswansonquotes_sdk.php`) exports the SDK class
