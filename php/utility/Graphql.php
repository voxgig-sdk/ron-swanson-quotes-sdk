...
// RonSwansonQuotes SDK utility: graphql
//
...
class RonSwansonQuotesGraphql
{
    ...
    // equivalent.
    public static function body(RonSwansonQuotesContext $ctx): mixed
    {
    ...
    public static function errors(RonSwansonQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
