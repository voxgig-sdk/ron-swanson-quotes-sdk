...
// RonSwansonQuotes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RonSwansonQuotesTransformResponse
{
    public static function call(RonSwansonQuotesContext $ctx): mixed
    {
        ...
        $transform = RonSwansonQuotesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
