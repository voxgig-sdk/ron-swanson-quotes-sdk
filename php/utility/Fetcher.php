...
// RonSwansonQuotes SDK utility: fetcher

class RonSwansonQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RonSwansonQuotesSDK/1.0)';
    ...
    public static function call(RonSwansonQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
