// Command RonSwansonQuotes-mcp is an MCP server exposing the RonSwansonQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RonSwansonQuotes_list  — list records of an entity
//	RonSwansonQuotes_load  — load a single record of an entity
//
