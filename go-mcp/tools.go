...
type Args struct {
	Entity string         `json:"entity" jsonschema:"quote | schema"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RonSwansonQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ron-swanson-quotes_list",
		Description: "List records from RonSwansonQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ron-swanson-quotes_load",
		Description: "Load a single record from RonSwansonQuotes. " +
...
func runOp(client *sdk.RonSwansonQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RonSwansonQuotesSDK, name string) (sdk.RonSwansonQuotesEntity, error) {
