...
This API provides a simple way to retrieve quotes from Ron Swanson, a character from the television show Parks and Recreation.

Learn more about Ron Swanson Quotes API at [ron-swanson-quotes.herokuapp.com](https://ron-swanson-quotes.herokuapp.com).
