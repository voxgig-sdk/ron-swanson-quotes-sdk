...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/ron-swanson-quotes` | `npm install @voxgig-sdk/ron-swanson-quotes` |
| Python | `voxgig-sdk-ron-swanson-quotes` | `pip install voxgig-sdk-ron-swanson-quotes` |
| PHP | `voxgig-sdk/ron-swanson-quotes` | `composer require voxgig-sdk/ron-swanson-quotes` |
| Golang | `github.com/voxgig-sdk/ron-swanson-quotes-sdk/go` | `go get github.com/voxgig-sdk/ron-swanson-quotes-sdk/go` |
| Ruby | `voxgig-sdk-ron-swanson-quotes` | `gem install voxgig-sdk-ron-swanson-quotes` |
| Lua | `voxgig-sdk-ron-swanson-quotes` | `luarocks install voxgig-sdk-ron-swanson-quotes` |
