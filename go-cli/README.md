...
AQL-driven CLI and REPL for the RonSwansonQuotes SDK. Positional arguments are
...
```sh
go build -o ron-swanson-quotes-cli ./...
```
...
./ron-swanson-quotes-cli load 1 quote
./ron-swanson-quotes-cli load '{id:1}' quote
