...
func registerSDKWords(r *eng.Registry, client *sdk.RonSwansonQuotesSDK) {
...
func runOp(client *sdk.RonSwansonQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
