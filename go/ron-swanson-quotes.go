...
// instead of `sdk.NewRonSwansonQuotesSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RonSwansonQuotesSDK  { return NewRonSwansonQuotesSDK(nil) }
func Test() *RonSwansonQuotesSDK { return TestSDK(nil, nil) }
