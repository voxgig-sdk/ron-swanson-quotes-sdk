...
const testSeed = `map[string]any{"entity": map[string]any{"quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
