...
func TestQuoteEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set RONSWANSONQUOTES_TEST_QUOTE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func quoteBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("RONSWANSONQUOTES_TEST_QUOTE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["RONSWANSONQUOTES_TEST_QUOTE_ENTID"])
