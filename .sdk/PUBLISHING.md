...
|---|---|---|
| `ts/` | @voxgig-sdk/ron-swanson-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ron-swanson-quotes-sdk \
      --repository voxgig-sdk/ron-swanson-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ron-swanson-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ron-swanson-quotes-sdk --id=<id>` removes it.
