...
// RonSwansonQuotes SDK clienttrack feature
...
class RonSwansonQuotesClienttrackFeature extends RonSwansonQuotesBaseFeature
{
    ...
    public function PostConstruct(RonSwansonQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RonSwansonQuotes-SDK';
