...
// RonSwansonQuotes SDK ratelimit feature
...
class RonSwansonQuotesRatelimitFeature extends RonSwansonQuotesBaseFeature
{
    ...
    private function _acquire(RonSwansonQuotesContext $ctx): void
    {
    ...
    private function _track(RonSwansonQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
