...
// RonSwansonQuotes SDK utility type

class RonSwansonQuotesUtility
{
    ...
    public static function copy(RonSwansonQuotesUtility $src): RonSwansonQuotesUtility
    {
        $u = new RonSwansonQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
