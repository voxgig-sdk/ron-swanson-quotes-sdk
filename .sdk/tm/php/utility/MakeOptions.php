...
// RonSwansonQuotes SDK utility: make_options

class RonSwansonQuotesMakeOptions
{
    ...
    public static function call(RonSwansonQuotesContext $ctx): array
    {
        ...
        //
        // `RonSwansonQuotesSchema::optspec()` is built from the model:
        ...
        $optspec = RonSwansonQuotesSchema::optspec();
